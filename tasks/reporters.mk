report-types: ## Generate the project mypy type report.
	poetry run mypy jax_utils/ tests/ > reports/mypy.txt || true
...
report-quality: ## Generate the project quality report.
	poetry run ruff check --output-format=json --output-file=reports/ruff.json jax_utils/ tests/ || true

report-security: ## Generate the project security report.
	poetry run bandit --recursive --format=json --output=reports/bandit.json jax_utils/ || true
